...
#define PLAYLIST_PLAYING_COLOR 4
#define SONG_INFO_COLOR 5
#define SONG_INFO_PLAYING_COLOR 6
#define SONG_INFO_SEL_COLOR 7
#define EXPLORER_COLOR 8
#define EXPLORER_SEL_COLOR 9
#define EXPLORER_DIR_COLOR 10
#define EXPLORER_DIR_SEL_COLOR 11
